...
public class ViewFlow extends AdapterView<Adapter> {
	...
	private static CopyOnWriteArrayList<ViewChangeListener> ViewChange_listeners = new CopyOnWriteArrayList<ViewChangeListener>();
...
//		}
	...
	public void setFlowIndicator(FlowIndicator flowIndicator) {
		...
		mIndicator.setViewFlow(ViewFlow.this);
	}
	...
	private void postViewSwitched(int direction) {
		...
		getViewPosition(mCurrentAdapterIndex);
	}
...
//	
	 ...
	 * @param bmp
	 */
	private static void getViewPosition(int position) {
		for (ViewChangeListener listener:ViewChange_listeners)
			listener.getViewPosition(position);
	}
	...
	public static void addListener (ViewChangeListener listener) {
		ViewChange_listeners.add(listener);
	}
	 ...
	 * @param listener
	 */
	public static void removeListener (ViewChangeListener listener) {
		ViewChange_listeners.remove(listener);
	}
	...
	public interface ViewChangeListener {
		...
		public void getViewPosition(final int position);
